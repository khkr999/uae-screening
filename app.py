...
with tab_home:
    ...
    with right_col:
        if selected_entity_row is not None:
            render_entity_panel(selected_entity_row, closeable=True, scope="overview")
        else:
            ...
            st.markdown(
                ...
                <div class="drawer-panel">
                  <div class="section-title">Overview Panel</div>
                  <div style="color:{c['text']};font-size:15px;font-weight:800;margin:6px 0;">Select an entity to start reviewing</div>
                  <div style="color:{c['text_muted']};font-size:12px;line-height:1.7;">
                    This panel becomes your active workspace when you choose an entity from the queue or search tab. Until then, the run summary below gives you context for the current export.
                  </div>
                </div>
                """,
                unsafe_allow_html=True,
